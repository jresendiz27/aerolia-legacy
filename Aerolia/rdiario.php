...
require_once "./include/drpdf.php";
                ...
                <div id="tabs">
                    ...
                    <div id="tabs-1" style="height: auto; text-align: center;">
                        ...
                        if ($user_card->is_session_active()) {
                            ...
                            $result = DataLog::request_daily_data($user_card->aero[0], $_GET["date"], $db_wrapper);

                            if ($result !== null) {
                                DataLog::generate_daily_report($user_card->aero[0], $_GET["date"], $result, Array(1, 2, 3, 4));
                            } else {
                        ?>
                                <h1>No hay datos disponibles para la fecha solicitada...</h1>
                        <?php
                            }
                        } else {
                        ?>
